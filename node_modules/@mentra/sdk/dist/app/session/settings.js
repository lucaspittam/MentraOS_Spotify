...
class SettingsManager {
    ...
    updateMentraosSettings(newSettings) {
        ...
        logger_1.logger.debug(`[SettingsManager] Updating MentraOS settings. New settings:`, newSettings);
        ...
        logger_1.logger.debug(`[SettingsManager] Finished updating MentraOS settings. Current state:`, this.mentraosSettings);
    }
    /**
    ...
    onMentraosSettingChange(key, handler) {
        ...
        this.mentraosEmitter.on(eventName, (...args) => {
            logger_1.logger.info(`[SettingsManager] MentraOS setting '${key}' event fired. Args:`, args);
            handler(...args);
        });
        if (this.subscribeFn) {
